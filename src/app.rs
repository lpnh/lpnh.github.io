    ...
    view! {
        <div class="font-fira-mono flex flex-col bg-stone-950 min-h-screen text-base text-center text-gray-300">
            <div class="flex-1 flex flex-col items-center">
                <div class="flex flex-1 sm:pt-16 pt-10 sm:pb-8 pb-12 md:w-full md:max-w-4xl justify-center">            
                    <Home/>
                </div>
                <Footer/>
            </div>
...
fn Home() -> impl IntoView {
    view! {
        <div class="flex flex-col items-center justify-center space-y-24">
            // Greeting
            <div class="md:text-2xl text-xl text-amber-200 italic">
                <p class="tracking-widest">"Hello, friend"</p>
            </div>
            // Main Content
            <div
                class="flex flex-grow mb-auto justify-center items-center"
            >
                <div class="flex md:flex-row flex-col justify-center items-center md:items-end md:text-3xl text-2xl md:space-x-12 space-x-0 md:space-y-0 space-y-12 transition-colors duration-200">
                    <a
                    ...
                    >
                        ...
                        <p class="tracking-wide md:w-64">"Blog"</p>
                    </a>
                    <a
                        class="flex flex-col items-center space-y-4 md:hover:text-orange-400 active:text-orange-400 transition-colors duration-200"
                        href="/maze"
                    >
                        ...
                        <p class="tracking-wide md:w-64">"Maze"</p>
                    </a>
                    <a
                        class="flex flex-col items-center space-y-4 md:hover:text-orange-400 active:text-orange-400 transition-colors duration-200"
                        href="/why-rust"
                    >
                        ...
                        <p class="tracking-wide md:w-64">"Why Rust?"</p>
                    </a>
                </div>
            </div>
            // Contact
            <div class="md:mb-16 mb-10 md:w-96">
                ...
                <div class="mt-4 flex flex-row justify-around items-center space-x-6">
                    ...
                    <a href="mailto:paniguel@lpnh.io" class="justify-center items-center flex flex-col space-y-2 md:hover:text-rose-400 active:text-rose-400 transition-colors duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
                        ...
                        <p class="md:text-base text-sm">"gmail"</p>
                    </a>
